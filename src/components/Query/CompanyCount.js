        ...
        return (
            <View style={styles.blockContainer}>
                <View style={styles.row}>
                    ...
                    <Text style={[styles.longLabel,styles.markTitle]}>派工单位:</Text>
                    <Text style={[styles.contentText,styles.markTitle]}>{this.props.data.company}</Text>
                </View>
                <View style={styles.row}>
                ...
                <View style={styles.row}>
                    ...
                    <Text style={styles.contentText}>{this.props.data.worker}</Text>
                </View>
                <View style={styles.row}>
